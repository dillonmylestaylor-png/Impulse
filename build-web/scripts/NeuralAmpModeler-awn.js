/* Declares the NeuralAmpModeler Audio Worklet Node */

class NeuralAmpModelerController extends WAMController
{
  constructor (actx, options) {
    ...
    super(actx, "NeuralAmpModeler", options);
  }
  ...
  static importScripts (actx) {
    ...
    return new Promise( (resolve) => {
      actx.audioWorklet.addModule(origin + "scripts/NeuralAmpModeler-wam.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/wam-processor.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/NeuralAmpModeler-awp.js").then(() => {
        resolve();
      }) }) });
    })
  }
