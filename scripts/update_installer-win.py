...
def main():
    ...
    for line in fileinput.input(
        ...
        if "OutputBaseFilename" in line:
            if demo:
                line = "OutputBaseFilename=Impulse Demo Installer\n"
            else:
                line = "OutputBaseFilename=Impulse Installer\n"
        ...
        if "WelcomeLabel1" in line:
            if demo:
                line = "WelcomeLabel1=Welcome to the Impulse Demo installer\n"
            else:
                line = "WelcomeLabel1=Welcome to the Impulse installer\n"

        if "SetupWindowTitle" in line:
            if demo:
                line = "SetupWindowTitle=Impulse Demo installer\n"
            else:
                line = "SetupWindowTitle=Impulse installer\n"
