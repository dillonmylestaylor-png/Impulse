...
def main():
    ...
    plistpath = projectpath + "/resources/Impulse-VST3-Info.plist"
    ...
    plistpath = projectpath + "/resources/Impulse-AU-Info.plist"
    with open(plistpath, "rb") as f:
    ...
    plistpath = projectpath + "/resources/Impulse-macOS-AUv3-Info.plist"
    ...
    with open(plistpath, "rb") as f:
        ...
        auv3["NSExtension"] = dict(
            ...
            NSExtensionPrincipalClass="IPlugAUViewController_vImpulse",
        )
    ...
    plistpath = projectpath + "/resources/Impulse-AAX-Info.plist"
    with open(plistpath, "rb") as f:
        aax = plistlib.load(f)
    ...
    plistpath = projectpath + "/resources/Impulse-macOS-Info.plist"
